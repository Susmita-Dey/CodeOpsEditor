                        ...
                        <div class="flex flex-wrap -m-2">
                            <div class="p-2 w-1/2">
                                <div class="relative">
                                    ...
                                    <input type="text" id="name" name="name" class="w-full text-base outline-none py-1 px-3 leading-8 bg-gray-500" />
                                </div>
                            </div>
                            <div class="p-2 w-1/2">
                                <div class="relative">
                                    <label for="email" class="leading-7 text-sm">Email</label>
                                    <input type="email" id="email" name="email" class="w-full text-base outline-none py-1 px-3 leading-8 bg-gray-500" />
                                </div>
                            </div>
                            <div class="p-2 w-full">
                                <div class="relative">
                                    <label for="message" class="leading-7 text-sm">Message</label>
                                    <textarea id="message" name="message" class="w-full h-32 text-base outline-none py-1 px-3 resize-none leading-6 bg-gray-500"></textarea>
                                </div>
                            </div>
                            <div class="p-2 w-full">
